      ...
      <section className="flex flex-col lg:flex-row  py-8 sm:py-12 md:py-16 lg:py-24 relative">
        ...
        <div className="z-[2] flex flex-col  items-center w-full">
          ...
          <div className="font-semibold text-sm lg:text-base 2xl:text-lg max-w-[800px] text-center mt-4">
            ...
            ReliaVet, we&apos;re here to support your journey every step of the
            way. With resources to boost your skills, access to job
            opportunities, and a community of fellow technicians, ReliaVet is
            your partner in delivering the best care for animals and advancing
            in your career.
          </div>
        </div>
        <img
