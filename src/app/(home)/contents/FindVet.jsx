  ...
  return (
    <section className="container flex lg:flex-row flex-col justify-center lg:justify-between max-lg:gap-5 items-center mx-auto sm:py-24 py-10  max-sm:px-10 relative">
      ...
      <div className="w-full max-w-[600px] flex flex-col justify-between">
        <h2 className="2xl:text-[40px] text-[28px] md:text-[30px] lg:text-[35px] xl:text-[38px] font-semibold leading-[48px] lg:mb-10 md:mb-5 mb-3">
          Find the Best Care for Your Pet with Trusted Veterinarians
        </h2>
        <p className="text-xs lg:text-sm 2xl:text-base !leading-[2] block text-[#636363] mb-5 lg:mb-10">
        ...
        <button className="bg-bgPrimaryGradient py-5 lg:py-6 md:py-8 2xl:py-10 w-full text-white sm:max-w-[350px] text-xs lg:text-sm 2xl:text-2xl font-bold rounded-lg hover:bg-bgPrimaryGradient2 hover:shadow-lg">
          Get Started
        </button>
      </div>
