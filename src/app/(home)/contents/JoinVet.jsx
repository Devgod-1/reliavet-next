      ...
      <div>
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full flex flex-col justify-center space-y-8 bg-[linear-gradient(213.61deg,#243A8E_10.73%,#5774CD_38.22%,#B13A66_72.38%,#DE1E33_89.27%)] p-10  lg:p-20">
            <span className="bg-red-primary rounded-full w-fit p-2 px-3 flex items-center text-white text-[10px] lg:text-xs 2xl:text-sm pr-8">
              <img
            ...
            <h2 className="text-[28px] lg:text-[32px] 2xl:text-[36px] font-bold leading-[1.4] lg:leading-[1.1] text-white !mt-4">
              Grow Your Practice with <br className="hidden lg:block" />
              Easy-to-Use Tools
            </h2>
            <p className="text-xs lg:text-sm 2xl:text-base !leading-[2] block text-white !mt-8">
            ...
            <button className="bg-transparet p-6 py-4 2xl:p-7 2xl:py-5 w-fit text-white max-w-[300px] !mt-12 text-xs lg:text-sm 2xl:text-base border border-white font-bold rounded-lg">
              Join as vet
            </button>
          </div>
        </div>
