        ...
        <div className="w-full flex max-lg:flex-col items-center bg-[#FFFFFF]/25 rounded-[20px] lg:rounded-[40px] overflow-hidden">
          ...
          <div className="p-4 lg:p-8 w-full lg:w-[50%] flex flex-col items-center justify-center">
            ...
            <div className="text-xs !leading-[1.7] 2xl:text-sm text-[#636363] text-center p-5 pt-0 lg:px-8">
              ...
              technician face-to-face. Sometimes you may just have a question or
              need something explained in more detail. With teleadvice, you can
              speak directly to a technician over the telephone and get reliable
              answers to your questions. <br /> Teleadvice is only used for
              informational purposes and general advice. Our technicians are not
              allowed to diagnose, treat, or prescribe medications using
              teleadvice.
            </div>
          </div>
        </div>
