  ...
  return (
    <div className="overflow-hidden">
      <div className="container mx-auto pt-24 max-lg:p-10">
        ...
        <p className="w-full md:w-[65%]  font-medium text-base 2xl:text-lg">
      ...
      <div className="flex flex-col md:flex-row relative">
        ...
        <div className="flex flex-col justify-center mx-auto lg:pr-[4%] 2xl:pr-[8%]">
          <div className="border p-10 lg:px-20 lg:py-16 2xl:px-28 2xl:py-20 rounded-3xl max-lg:rounded-none bg-[#000000]/5 backdrop-blur-sm">
            ...
            <ul className="list-disc w-full text-sm 2xl:text-base pl-5">
              <li>
                Telemedicine Options: &quot;Provide remote consultations for
              ...
              <li>
                Secure Messaging: &quot;Keep communication private and protected
                with secure messaging options.&quot;
              </li>
            </ul>
          </div>
        </div>
