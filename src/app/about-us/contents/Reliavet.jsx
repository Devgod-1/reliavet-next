  ...
  return (
    <div className="flex max-lg:flex-col">
      <div className="w-full">
        <img src="/assets/images/reliavet_pet.png" alt="pet" />
      </div>
      <div
      ...
      >
        <h1 className="leading-[1.1] text-[27px] md:text-[35px] lg:text-[40px] xl:text-[50px] 2xl:text-[68px] font-bold">
          Reliavet
        </h1>
        <p className="w-full text-center text-sm lg:text-base 2xl:text-lg !leading-[1.8] font-semibold mt-6">
        ...
        <button className="w-full max-w-[230px] font-bold border rounded-lg py-6 my-10 text-lg lg:text-xl 2xl:text-2xl">
          Get Started
        </button>
      </div>
    </div>
